...
{
    // -- Players --
    public static Color player = new(0.65f, 0.3f, 0.95f, 1f);
    public static Color opponent = new(0.1f, 0.26f, 0.78f, 1f);

    // -- UI --
    public static Color neutralDark = new(0.1f, 0.1f, 0.12f, 1f);
    public static Color neutral = new(0.15f, 0.15f, 0.16f, 1f);
    public static Color neutralLight = new(0.25f, 0.25f, 0.28f, 1f);
    public static Color primary = new(0.16f, 0.27f, 0.12f, 1f);
    public static Color primaryLight = new(172, 203, 124, 1f);

    // -- Play Board --
    public static Color creature = new(0.34f, 0f, 0f, 1f);
    public static Color technology = new(0.65f, 0.45f, 0.25f, 1f);
    public static Color trash = new(0.3f, 0.3f, 0.3f, 1f);
    public static Color cash = new(0.77f, 0.95f, 1f, 1f);
    public static Color costValue = new(1f, 0.9f, 0.3f, 1f);
    public static Color attackValue = new(0.96f, 0.27f, 0.25f, 1f);
    public static Color healthValue = new(0.2f, 0.44f, 0.92f, 1f);
    public static Color pointsValue = new(0.37f, 0.77f, 0.29f, 1f);
    public static Color prevailColor = new(0.7f, 0.9f, 0.5f, 1f);
    ...
    public static Color creatureIdle = new(200, 200, 200, 255);
